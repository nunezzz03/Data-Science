...
# Import step modules
# We use importlib to allow for dynamic imports if needed, but direct import is fine here
# assuming the filenames are valid python identifiers (they are).
import lab3_config as config

# We need to import the modules. Since they start with numbers, we can't do "import 1_encoding".
# We use importlib.
