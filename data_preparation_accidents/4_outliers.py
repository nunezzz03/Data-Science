...
# Save
train_df.to_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_4.csv", index=False)
test_df.to_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_4.csv", index=False)
...
target = "crash_type"
file_tag = "crash"
train: DataFrame = read_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_4.csv")
test: DataFrame = read_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_4.csv")
...
savefig(f"data_preparation_accidents/preparation_images/{file_tag}_eval_4.png")
show()
...
plot_conf_matrix(tstY, pred_NB, "NB Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_NB_confusion_4.png")
plot_conf_matrix(tstY, pred_KNN, "KNN Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_KNN_confusion_4.png")