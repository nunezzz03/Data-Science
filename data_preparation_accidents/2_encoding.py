...
# Save
train_df.to_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_2.csv", index=False)
test_df.to_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_2.csv", index=False)
...
target = "crash_type"
file_tag = "crash"
train: DataFrame = read_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_2.csv")
test: DataFrame = read_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_2.csv")
...
savefig(f"data_preparation_accidents/preparation_images/{file_tag}_eval_2.png")
show()
...
plot_conf_matrix(tstY, pred_NB, "NB Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_NB_confusion_2.png")
plot_conf_matrix(tstY, pred_KNN, "KNN Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_KNN_confusion_2.png")