...
data: DataFrame = read_csv(
    "data/raw/traffic_accidents.csv", na_values="", parse_dates=True, dayfirst=True
)
...
if numeric_vars is not None:
    ...
    df.to_csv(f"data_preparation_accidents/outlier_datasets/{file_tag}_drop_outliers.csv", index=True)
...
# Load dataset
df = read_csv(f"data_preparation_accidents/outlier_datasets/crash_drop_outliers.csv")
...
# Save
train_df.to_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_5.csv", index=False)
test_df.to_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_5.csv", index=False)
...
target = "crash_type"
file_tag = "crash"
train: DataFrame = read_csv("data_preparation_accidents/train_datasets/traffic_accidents_train_5.csv")
test: DataFrame = read_csv("data_preparation_accidents/test_datasets/traffic_accidents_test_5.csv")
...
savefig(f"data_preparation_accidents/preparation_images/{file_tag}_eval_5.png")
show()
...
plot_conf_matrix(tstY, pred_NB, "NB Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_NB_confusion_5.png")
plot_conf_matrix(tstY, pred_KNN, "KNN Confusion Matrix (%)", f"data_preparation_accidents/preparation_images/{file_tag}_KNN_confusion_5.png")