...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{2_imputation_comparison.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{3_outliers_comparison.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{4_scaling_comparison.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{5_balancing_comparison.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{6_selection_redundancy_f1.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\textwidth]{6_selection_variance_f1.png}
