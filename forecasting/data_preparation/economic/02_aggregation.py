...
RAW_FILE = f"{DATA_SCIENCE_ROOT}/data/raw/economic_indicators_dataset_2010_2023.csv"
...
# For monthly data: Q=quarterly, 2M=bi-monthly, 6M=semi-annual
AGGREGATION_CONFIGS = [
    {"name": "Monthly", "gran_level": "M", "agg_func": "mean"},  # Keep as-is
    {"name": "Quarterly_Mean", "gran_level": "Q", "agg_func": "mean"},
    {"name": "Quarterly_Median", "gran_level": "Q", "agg_func": "median"},
]
...
def main():
    print("Lab 5 - Aggregation Analysis for Economic Time Series (USA)")
    print("=" * 60)
