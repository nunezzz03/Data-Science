...
def get_dataset_dirs(dataset_name):
    ...
    images_dir = os.path.join(base_dir, 'images', 'differentiation')
    processed_dir = os.path.join(base_dir, 'processed_data', 'differentiation')
...
def run_differentiation_study(aggregated_dataset_path, dataset_name):
    IMAGES_DIR, RESULTS_DIR = get_dataset_dirs(dataset_name)
